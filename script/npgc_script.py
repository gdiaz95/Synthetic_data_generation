...
synthetic data using the NPGC model, logging evaluation results to W&B.
"""
...
def main(args):
    ...
    # --- ADDED: TSTR (Machine Learning Utility) Configuration ---
    tstr_models = {
    ...
    for i in range(1, TOTAL_ITERATIONS + 1):
        ...
        print(f"Using epsilon for differential privacy: {getattr(synthesizer, 'epsilon', 'N/A')}")
